...
class Jeff
{
	...
	public static void createFile() throws Exception
	{
		...
		java.io.FileWriter fw = new java.io.FileWriter( new java.io.File( "c:\\temp", "jeff.log" ) );
	}
	...
	public static void readFile() throws Exception
	{
		...
		java.io.FileReader fr = new java.io.FileReader( new java.io.File( "c:\\temp", "jeff.log" ) );
	}

	// try to delete a file
	public static void deleteFile() throws Exception
	{
		System.out.println( "\nAttempting to delete a file called jeff.log" );
	...
	public static void createServer() throws Exception
	{
		...
		java.net.ServerSocket server = new java.net.ServerSocket( 68 );
	}
	...
	public static void createClient() throws Exception
	{
		...
		java.net.Socket client = new java.net.Socket( "localhost", 76 );
	}
